...
public class FindUsersUsingQueriesTest extends JavaPersistenceWithHibernateApplicationTests {
    ...
    void testFindByRegistrationDateBetween() {
        List<User> users = userRepository.findAllByRegistrationDateBetween(
