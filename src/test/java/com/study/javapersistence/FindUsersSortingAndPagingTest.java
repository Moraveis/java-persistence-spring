...
public class FindUsersSortingAndPagingTest extends JavaPersistenceWithHibernateApplicationTests {
    ...
    void testFindByLevel() {
        ...
        List<User> users = userRepository.findByLevel(3, userSort.by(User::getRegistrationDate).descending());
